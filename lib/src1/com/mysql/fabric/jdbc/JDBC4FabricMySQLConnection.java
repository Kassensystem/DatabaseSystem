...
public interface JDBC4FabricMySQLConnection extends com.mysql.jdbc.JDBC4MySQLConnection {
    ...
    /**
     * Clear the list of database.tables for the last query. This also clears the
    ...
    /**
     * Add a table to the set of database.tables used for the next query on this connection.
     * This is used for:
     * <ul>
     * <li>Choosing a shard given the database.tables used</li>
    ...
    /**
     * The set of database.tables to be used in the next query on this connection.
     */
