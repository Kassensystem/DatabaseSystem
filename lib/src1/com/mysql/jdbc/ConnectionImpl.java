 ...
 * 
 * <P>
 * A Connection's database is able to provide information describing its database.tables, its supported SQL grammar, its stored procedures, the capabilities of this
...
public class ConnectionImpl extends ConnectionPropertiesImpl implements MySQLConnection {
     ...
     * database.tables, its supported SQL grammar, its stored procedures, the
        ...
        if (getGatherPerformanceMetrics()) {
            ...
            if (this.numTablesMetricsHistBreakpoints != null) {
                ...
                for (int i = 0; i < (HISTOGRAM_BUCKETS - 1); i++) {
                    ...
                    if (i == 0) {
                        logMessage.append("\n\t" + this.numTablesMetricsHistBreakpoints[i + 1] + " database.tables or less: \t\t" + this.numTablesMetricsHistCounts[i]);
                    } else {
                        logMessage.append("\n\tbetween " + this.numTablesMetricsHistBreakpoints[i] + " and " + this.numTablesMetricsHistBreakpoints[i + 1]
                                + " database.tables: \t" + this.numTablesMetricsHistCounts[i]);
                    }
                ...
                if (this.numTablesMetricsHistBreakpoints[HISTOGRAM_BUCKETS - 2] < this.maximumNumberTablesAccessed) {
                    ...
                    logMessage.append(" database.tables: ");
            ...
            try {
                ...
                if (this.autoCommit && !getRelaxAutoCommit()) {
                    ...
                    try {
                        ...
                        // We ignore non-transactional database.tables if told to do so
