 ...
 * 
 * <p>
 * In the 'setUp' method, create code that creates your database.tables, and populates them with any data needed to demonstrate the bug.
 * 
 * <p>
 * In the 'runTest' method, create code that demonstrates the bug using the database.tables and data you created in the 'setUp' method.
 * 
 * <p>
 * In the 'tearDown' method, drop any database.tables you created in the 'setUp' method.
 * 
 * <p>
...
public abstract class BaseBugReport {
     ...
     * demonstrating your bug (creating database.tables, populating data, etc).
     * 
     * @throws Exception
