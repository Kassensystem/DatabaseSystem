...
public class MetaDataRegressionTest extends BaseTestCase {
    ...
    /**
     * Tests fix for BUG#9778, DBMD.getTables() shouldn't return database.tables if views
    ...
    /**
     * Tests fix for BUG#63456 - MetaData precision is different when using UTF8 or Latin1 database.tables
     * 
     * @throws Exception
     *             if the test fails.
     */
     ...
     * Delimited names of databases and database.tables are handled correctly now. The edge case is ANSI quoted
